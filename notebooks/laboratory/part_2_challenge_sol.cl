...
#define BATCH_SIZE 4
#define WORD_CACHE_SIZE 50

// C version of Java's String hash code function
// Adapted from https://docs.oracle.com/javase/1.5.0/docs/api/java/lang/String.html#hashCode()
// Uses private memory to cache multiple words and perform operations on them
kernel void java_hash_batched(global char *words,
    ...
    //Copying the words into a cache
    char private_words[WORD_CACHE_SIZE];
